...
class ToolNextViewController: UIViewController {
        ...
        if (sender as AnyObject).tag == 1{
         challengerAnswer = "A"
           ...
           func screenTransition(){
               let tAVC = storyboard?.instantiateViewController(identifier: "toolTheAnswer") as! ToolTheAnswerViewController
