//
//  AthleteNextViewController.swift
//  Swift6firestore1
//
...
class AthleteNextViewController: UIViewController {
        ...
        if (sender as AnyObject).tag == 1{
         challengerAnswer = "A"
           ...
           func screenTransition(){
               let tAVC = storyboard?.instantiateViewController(identifier: "athleteTheAnswer") as! AthleteTheAnswerViewController
