//
//  RefereeNextViewController.swift
//  Swift6firestore1
//
...
class RefereeNextViewController: UIViewController {
        ...
        if (sender as AnyObject).tag == 1{
         challengerAnswer = "A"
           ...
           func screenTransition(){
               let tAVC = storyboard?.instantiateViewController(identifier: "refreeTheAnswer") as! RefereeTheAnswerViewController
