//
//  GardenNextViewController.swift
//  Swift6firestore1
//
...
class GardenNextViewController: UIViewController {
    ...
    @IBAction func answer(_ sender: Any) {
       ...
       func screenTransition(){
           let tAVC = storyboard?.instantiateViewController(identifier: "gardenTheAnswer") as! GardenTheAnswerViewControllerViewController
