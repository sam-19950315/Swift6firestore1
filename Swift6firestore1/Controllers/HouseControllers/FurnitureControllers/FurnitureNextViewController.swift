//
//  FurnitureNextViewController.swift
//  Swift6firestore1
//
...
class FurnitureNextViewController: UIViewController {
        ...
        if (sender as AnyObject).tag == 1{
         challengerAnswer = "A"
           ...
           func screenTransition(){
               let tAVC = storyboard?.instantiateViewController(identifier: "furnitureTheAnswer") as! FurnitureTheAnswerViewController
