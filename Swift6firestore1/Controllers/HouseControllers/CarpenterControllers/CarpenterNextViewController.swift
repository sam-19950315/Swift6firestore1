//
//  CarpenterNextViewController.swift
//  Swift6firestore1
//
...
class CarpenterNextViewController: UIViewController {
        ...
        if (sender as AnyObject).tag == 1{
         challengerAnswer = "A"
           ...
           func screenTransition(){
               let tAVC = storyboard?.instantiateViewController(identifier: "carpenterTheAnswer") as! CarpenterTheAnswerViewController
