...
class ToyNextViewController: UIViewController {
    ...
    @IBAction func answer(_ sender: Any) {
       ...
       func screenTransition(){
           let tAVC = storyboard?.instantiateViewController(identifier: "toyTheAnswer") as! ToyTheAnswerViewController
