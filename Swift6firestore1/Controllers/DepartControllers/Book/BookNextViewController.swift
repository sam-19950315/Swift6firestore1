...
class BookNextViewController: UIViewController {
    ...
    @IBAction func answer(_ sender: Any) {
       ...
       func screenTransition(){
           let tAVC = storyboard?.instantiateViewController(identifier: "bookTheAnswer") as! BookTheAnswerViewController
